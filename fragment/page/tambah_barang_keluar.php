...
if(isset($_POST['simpan'])){
    ...
    $quantity_keluar = $_POST['quantity_keluar'];
    $id_operator = 1;
    $tgl = date('Y-m-d H:i:s', time());
    // insert into table barang masuk
    $query = "INSERT into tbl_barang_keluar (quantity_keluar, id_barang, id_operator, created_at, updated_at) values ('$quantity_keluar', '$id_barang', '$id_operator','$tgl','$tgl')";
        ...
        <form method="post" action="">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantity_keluar" placeholder="0" value="0" min="0">
                </div>
